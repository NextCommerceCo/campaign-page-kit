...
function resolveTemplateSource(family) {
    ...
    return {
        ...
        // Authenticated tarball (private families): GitHub's API tarball endpoint
        // honors an Authorization header and 302-redirects to a signed codeload
        // URL. Named explicitly so a caller can't reach for it on a public family
        // and accidentally make an authenticated request — public families use
